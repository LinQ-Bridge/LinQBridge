...
// identity scheme.
func New(validSchemes enr2.IdentityScheme, r *enr2.Record) (*Node, error) {
...
func Parse(validSchemes enr2.IdentityScheme, input string) (*Node, error) {
...
func (n *Node) Load(k enr2.Entry) error {
	return n.r.Load(k)
}
...
func (n *Node) Record() *enr2.Record {
	cpy := n.r
	return &cpy
}
