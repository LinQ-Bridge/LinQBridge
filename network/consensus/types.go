...
// Proposal supports retrieving height and serialized block to be used during LBFT consensus.
type Proposal interface {
	...
	// TxHash for get txhash sign
	TxHash() common.Hash

	// GetTxParam For sign
	GetTxParam() bridge.TxParam
}
